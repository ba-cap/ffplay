...
# 使用 ndk r20 版本
#NDK_DIR=/home/patrick/tools/google/as/sdk/ndk-bundle
NDK_DIR=/home/patrick/tools/google/as/ndk/android-ndk-r14b
...
#CFLAGS="-fPIC -DANDROID -O2 -Wall -Wextra -pipe -std=c99 -ffast-math"
 CFLAGS="-fPIC -DANDROID -O3 -Wall -Wextra -ffast-math"
...
function ffmpeg_build() {
    ...
    if [ "$ABI" = "armeabi-v7a" ]; then
        ...
        #MY_CFLAG="-I$SYSROOT/usr/include $CFLAGS -mfpu=neon -mfloat-abi=softfp "
         MY_CFLAG="$CFLAGS -march=armv7-a -mcpu=cortex-a8 -mfpu=neon -mfloat-abi=softfp "
    else
          MY_ARCH=arm64
              CPU=armv8-a
