...
//public class XGLSurfaceView extends GLSurfaceView implements Runnable {

public class XGLSurfaceView extends SurfaceView implements Runnable, SurfaceHolder.Callback {
    ...
    public void run() {
        ...
        open_player("/storage/emulated/0/ffmpeg-test/pptv_start_advert.mp4", getHolder().getSurface());
